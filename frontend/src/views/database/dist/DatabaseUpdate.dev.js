...
// export class DatabaseUpdate extends Component {
//     render() {
//         return (
//             <div>
//                 hi
...
// import { Form, Button, Brehiadcrumb } from 'react-bootstrap'
...
//             api.databaseListID(props.match.params.id)
//                 .then(response => {
...
//             head = (<Breadcrumb.Item active style={{cursor: 'pointer'}}>{databaseData.name}</Breadcrumb.Item>)
//         }
//     } else {
//         head = (<Breadcrumb.Item active style={{cursor: 'pointer'}}>DATABASE</Breadcrumb.Item>)
//     }
//     return (
