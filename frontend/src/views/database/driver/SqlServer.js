...
function Childrens(props) {
    const { engine, inputting, name, host, port, dbname, switches, dbInstanceName, username, password, sslSwitch, jdbc, sshTunnel, sshAuth, tunnelHost, tunnelPassword, tunnelPort, tunnelPrivateKey, tunnelUser, autoRunQueries, userControlScheduling, refingerprint} = props
    return (
        <>
            ...
            <Form.Group controlId="formBasicPort">
                ...
                <Form.Text>Input specific port. Standard port is 1433.</Form.Text>
                <Form.Control
                    type="number"
                    placeholder="1433"
                    value={port}
            ...
            <Form.Group controlId="formBasicDatabaseName">
                ...
                <Form.Control
                    ...
                    onChange={inputting("dbInstanceName")}
                />
            </Form.Group>
...
const { inputting,
        ...
        errorInput,
        parseScheduling,
        parseTunneling, changeKey, activeKey, refingerprint, updateLoading} = props
