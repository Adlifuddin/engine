                    ...
                    <Col style={{marginTop:"10px", marginRight:"50px"}} xs lg={9}>  
                        ...
                        <Row>
                            <Col>
                                ...
                                <BarChart margin={{left:150}} layout="vertical" width={600} height={600} data={popularqueries}>
                                    <CartesianGrid vertical={true} horizontal={false} />
                                    <XAxis tick={{ fontWeight:"bold" }} stroke="white" type="number" dataKey="executions"/>
                                    <YAxis tick={{ fontSize:"10.5px",fontWeight:"bold" }} tick={false} stroke="white" type="category" dataKey="card" />
                                    <Tooltip />
                            ...
                            <Col>
                                ...
                                <BarChart margin={{left:150}} layout="vertical" width={600} height={600} data={slowestqueries}>
                                    <CartesianGrid vertical={true} horizontal={false} />
