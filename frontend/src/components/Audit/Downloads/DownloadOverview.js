                    ...
                    <Col style={{marginTop:"10px", marginRight:"50px"}} xs lg={9}>  
                        ...
                        <Row>
                            <Col>
                                ...
                                <ScatterChart width={1200} height={300} margin={{ top: 20, right: 20, bottom: 30, left: 50 }}>
                                    <CartesianGrid  />
                            ...
                            <Col>
                                ...
                                <BarChart margin={{left:50, bottom: 30}} layout="vertical" width={500} height={280} data={downloadperUser}>
